...
parser.add_argument('--data_dir', default='TinyImagenet', type=str, help='path to data')
...
class bitplanetransform (object):
    def __call__(self,inputs):
        ...
        #inputs = bitplane_1 * 128 + bitplane_2 * 64 + bitplane_4 * 32 + bitplane_3 * 16 + bitplane_6 * 8 + bitplane_7 * 4 + bitplane_8 * 2 + bitplane_7 * 1  #s12436587
...
#if args.resume:
path_to_file = './TrainedModel/TinyImageNet_B'+str(bs)+'_LR'+lr1+'_'+net1+'_'+optimizer1+'.t7'
